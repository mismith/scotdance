...
<template>
  <div class="relative">
    ...
    <Transition
      ...
      enter-from-class="[clip-path:inset(0_0_calc(100%-3rem)_calc(100%-3rem)_round_1.5rem)]"
      ...
      leave-to-class="[clip-path:inset(0_0_calc(100%-3rem)_calc(100%-3rem)_round_1.5rem)]"
    >
      <div
        v-if="open"
