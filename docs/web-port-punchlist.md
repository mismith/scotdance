...
- [ ] **Placeholder dancer striped pattern** + HelpTip explaining placeholder dancers ([PlacedDancerList.vue:2](../src/components/PlacedDancerList.vue), [DancerListItem.vue:17](../src/components/DancerListItem.vue))
