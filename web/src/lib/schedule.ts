...
export function days(schedule: { days?: Record<string, Omit<ScheduleDay, 'id'>> } | null): ScheduleDay[] {
...
export function getScheduleDanceName(item: ScheduleDance, dancesList: EnrichedDance[]): string {
